			...
			<li {if $smarty.foreach.new.last} id="last"{/if}>
				...
				<p class="date_video">{$article.article_date} - {if $article.video_lien != 'vide'}<a href="http://www.youtube.com/watch?v={$article.video_lien}" target="blank">Vidéo ici</a>{else}Bientôt en vidéo{/if}</p>
